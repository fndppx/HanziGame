...
var DrawLayer1 = cc.Layer.extend({
    _bgGroundLayer:null,
    moveSprites:null,
    _lineWidth:10,
    _currentIndex:0,
    ...
    ctor:function(){
        ...
        cc.loader.loadTxt(aREx, function(err, data){
            ...
            if (that._dataArray){
                ...
                cc.log("keyword>>>>>",   graphics_dictionary["大"]);
                 ...
                 var index = graphics_dictionary["大"];
        ...
        var startItem = new cc.MenuItemImage(
            ...
            function(){
                ...
                var data = that._dataArray[that._selectIndex];
                _outlineDictionary = JSON.parse(data);
...
var DrawScene1 = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new DrawLayer1();
        this.addChild(layer);
